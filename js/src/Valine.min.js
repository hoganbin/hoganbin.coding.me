                ...
                return s(e, [{
                    ...
                    value: function(e) {
                        ...
                        try {
                            ...
                            var f = {
                                ...
                                g = e.placeholder || "",
                                k = '<div class="vwrap"><div class="vheader item' + v.length + '">' + v.join("") + '</div><div class="vedit"><textarea class="veditor vinput" placeholder="' + g + '"></textarea></div><div class="vcontrol"><div class="col col-60" title="Markdown is Support"><a href="https://segmentfault.com/markdown" target="_blank"></a> 支持 Markdown<div class="vlimit"></div></div><div class="col col-40 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><ul class="vlist"></ul><div class="vempty" style="display:none;"></div><div class="vpage txt-center" ></div><div class="info"><div class="power txt-right">  <a href="https://valine.js.org" target="_blank"></a> ';
                            t.el.innerHTML = k;
                    ...
                    value: function(e) {
                        ...
                        var O = function() {
                                ...
                                s.at = "", s.rid = "", s.rmail = "", b.nick = "匿名�?", t.el.querySelector(".vlimit").innerHTML = "", w()
                            },
                            S = t.el.querySelector(".vsubmit"),
                            $ = function(e) {
                                if (S.getAttribute("disabled")) return void t.alert.show({
                                    type: 0,
                                    text: t.locale.tips.busy + '�?(๑╹◡╹)�?"',
                                    ctxt: t.locale.ctrl.ok
                                });
                                if ("" == b.comment) return void u.comment.focus();
                                if (b.nick = "" == b.nick ? "匿名�?" : b.nick, b.comment.indexOf(s.at) > -1 && "" != s.at) {
                            ...
                            T = function e(n) {
                                t.v.User.requestPasswordReset(n.mail).then(function(e) {}).catch(function(r) {
                                    1 == r.code ? t.alert.show({
                                        type: 0,
                                        text: "�?(ｏ･ω�?)�? At太频繁啦，提醒功能暂时宕机�?<br>" + r.error,
                                        ctxt: t.locale.ctrl.ok
                                    }) : E(n).then(function(t) {
                                        e(n)
                                    }).catch(function(e) {})
